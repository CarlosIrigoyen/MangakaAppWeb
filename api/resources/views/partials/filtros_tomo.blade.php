<div class="card card-filtros p-3">
    ...
    <form id="filterForm" method="GET" action="{{ route('tomos.index') }}">
        ...
        {{-- mantiene activos / inactivos al filtrar --}}
        ...
        <div id="filterSelectContainer" class="mt-3">
            ...
            <select id="select-idioma"
                ...
                @foreach(['Español','Inglés','Japonés'] as $lang)
                    <option value="{{ $lang }}" {{ request('idioma') == $lang ? 'selected' : '' }}>
                        {{ $lang }}
                    </option>
                @endforeach
            </select>
...
<div class="modal fade"
     id="modalStock"
     tabindex="-1"
     aria-labelledby="modalUpdateMultipleStockLabel"
     aria-hidden="true">
            ...
            <form action="{{ route('tomos.updateMultipleStock') }}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="modal-title" id="modalUpdateMultipleStockLabel">
                            Actualizar Stock de Tomos
                        </h5>

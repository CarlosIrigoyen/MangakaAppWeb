...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive">
            <!-- La tabla ahora tiene un ID que identifica la tabla para DataTables. Evitamos usar el ID "Contenido" para estilos de ocultamiento -->
            <table id="autoresTable" class="table table-bordered table-hover dataTable dtr-inline" style="width:100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Nombre</th>

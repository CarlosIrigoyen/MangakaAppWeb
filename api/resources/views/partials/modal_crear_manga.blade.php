      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="formCrear" action="{{ route('mangas.store') }}" method="POST">
                    ...
                    <div class="col-3">
                      <div class="form-check">
                        <input class="form-check-input genero-checkbox"
                               type="checkbox"
                               id="genero_crear{{ $genero->id }}"
                               name="generos[]"
                               value="{{ $genero->id }}">
                        <label class="form-check-label" for="genero_crear{{ $genero->id }}">
                          {{ $genero->nombre }}
                        </label>
                      </div>
                    </div>
            ...
            <!-- Forzar en_publicacion = "si" -->
            <input type="hidden" name="en_publicacion" value="si">
